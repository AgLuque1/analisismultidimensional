"""
Django settings for bigdatamed project.
...
URL_CONFIG_API_REST = "http://127.0.0.1:5000/bigdatamed/"

# Quick-start development settings - unsuitable for production
# See https://docs.djangoproject.com/en/3.2/howto/deployment/checklist/

# SECURITY WARNING: keep the secret key used in production secret!
SECRET_KEY = 'django-insecure--@1i*hqwhjjj(*==)!prw*c-8eaw7yhu%#s9v^87esgs7+%3%#'
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            ...
            os.path.join(BASE_DIR, 'machinelearning/template'),
            os.path.join(BASE_DIR, 'analisismultidimensional/template'),
...
WSGI_APPLICATION = 'bigdatamed.wsgi.application'
...
STATICFILES_DIRS = [
    ...
    os.path.join(BASE_DIR, "analisismultidimensional/static"),
